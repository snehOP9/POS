...
export const LoginPage = () => {
  ...
  const submit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setStatus("loading");
    setMessage("");
    if (rememberDevice) window.localStorage.setItem("emberserve.rememberedStaffId", email); else window.localStorage.removeItem("emberserve.rememberedStaffId");
    try {
